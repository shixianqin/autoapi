...
export function deleteWpV2Id(options: {
  ...
  headers?: API.WordpressV2Json.Menus.DeleteWpV2Id.Headers;
...
export function getWpV2Id(options: {
  ...
  headers?: API.WordpressV2Json.Menus.GetWpV2Id.Headers;
  config?: RequestConfig;
  context?: RequestContext;
}) {
...
export function patchWpV2Id(options: {
  ...
  headers?: API.WordpressV2Json.Menus.PatchWpV2Id.Headers;
  config?: RequestConfig;
  context?: RequestContext;
}) {
  return request<any>(
...
export function postWpV2Id(options: {
  ...
  headers?: API.WordpressV2Json.Menus.PostWpV2Id.Headers;
...
export function putWpV2Id(options: {
  ...
  headers?: API.WordpressV2Json.Menus.PutWpV2Id.Headers;
  config?: RequestConfig;
  context?: RequestContext;
}) {
...
export function getWpV2(options?: {
  ...
  headers?: API.WordpressV2Json.Menus.GetWpV2.Headers;
  config?: RequestConfig;
  context?: RequestContext;
}) {
...
export function postWpV2(options: {
  headers?: API.WordpressV2Json.Menus.PostWpV2.Headers;
