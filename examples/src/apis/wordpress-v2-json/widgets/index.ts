...
export function deleteWpV2Id(options: {
  ...
  headers?: API.WordpressV2Json.Widgets.DeleteWpV2Id.Headers;
...
export function getWpV2Id(options: {
  ...
  headers?: API.WordpressV2Json.Widgets.GetWpV2Id.Headers;
  config?: RequestConfig;
  context?: RequestContext;
}) {
  return request<any>(
...
export function patchWpV2Id(options: {
  ...
  headers?: API.WordpressV2Json.Widgets.PatchWpV2Id.Headers;
  config?: RequestConfig;
  context?: RequestContext;
}) {
  return request<any>(
...
export function postWpV2Id(options: {
  ...
  headers?: API.WordpressV2Json.Widgets.PostWpV2Id.Headers;
...
export function putWpV2Id(options: {
  ...
  headers?: API.WordpressV2Json.Widgets.PutWpV2Id.Headers;
  config?: RequestConfig;
  context?: RequestContext;
}) {
  return request<any>(
...
export function getWpV2(options?: {
  ...
  headers?: API.WordpressV2Json.Widgets.GetWpV2.Headers;
  config?: RequestConfig;
  context?: RequestContext;
}) {
...
export function postWpV2(options: {
  headers?: API.WordpressV2Json.Widgets.PostWpV2.Headers;
